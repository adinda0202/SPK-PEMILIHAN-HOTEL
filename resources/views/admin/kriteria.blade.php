...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <span class="brand-text font-weight-light">KRITERIA</span>
        </a>
        <div class="sidebar">
        <!-- Sidebar -->
        <nav class="mt-2">
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">DATA KRITERIA HOTEL</h3>
                        ...
                        <tbody>
                            @foreach ($kriteria as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('kriteria/edit/'.$item->id) }}" class="btn-xs btn-primary">Edit</a>
                                        <!-- Form untuk delete -->
                ...
                <div class="card-footer clearfix">
                    <div class="row">
                        <div class="col-sm-2">
                            <li class="nav-item">
                                <a href="{{ route('kriteria.create') }}" class="nav-link btn btn-block btn-primary">
